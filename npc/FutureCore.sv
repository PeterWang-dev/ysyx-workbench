...
module FutureCore(	// @[<stdin>:132:10]
  input         clock,	// @[<stdin>:133:11]
                reset,	// @[<stdin>:134:11]
  input  [31:0] io_instIn,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
  output [31:0] io_instAddrOut,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
                io_debug_pcInstAddr,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
  output [4:0]  io_debug_instDecRs1,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
                io_debug_instDecRs2,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
                io_debug_instDecRd,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
  output        io_debug_instDecWriteEnable,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
                io_debug_instDecIsImmidiate,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
  output [31:0] io_debug_regFileRs1Data,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
                io_debug_regFileRs2Data,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
                io_debug_immGenImmidiate,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
                io_debug_adderResult	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:49:21]
);

  wire [31:0] _adder_io_result;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:55:25]
  wire [31:0] _immGen_io_immidiate;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:53:25]
  wire [31:0] _regFile_io_rs1Data;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:25]
  wire [31:0] _regFile_io_rs2Data;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:25]
  wire [4:0]  _instDec_io_rs1;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  wire [4:0]  _instDec_io_rs2;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  wire [4:0]  _instDec_io_rd;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  wire        _instDec_io_writeEnable;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  wire        _instDec_io_isImmidiate;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  wire        _instDec_io_isEbreak;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  wire [31:0] _pc_io_instAddr;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:25]
  ProgramCounter pc (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:25]
    .clock       (clock),
    .reset       (reset),
    .io_instAddr (_pc_io_instAddr)
  );
  InstDecoder instDec (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
    .io_inst        (io_instIn),
  ...
  RegFile regFile (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:25]
    .clock          (clock),
    .io_rs1Addr     (_instDec_io_rs1),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
    .io_rs2Addr     (_instDec_io_rs2),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
    .io_writeEnable (_instDec_io_writeEnable),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
    .io_rdAddr      (_instDec_io_rd),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
    .io_rdData      (_adder_io_result),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:55:25]
    .io_rs1Data     (_regFile_io_rs1Data),
    .io_rs2Data     (_regFile_io_rs2Data)
  );
  ImmGenerator immGen (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:53:25]
    .io_inst      (io_instIn),
    .io_immidiate (_immGen_io_immidiate)
  );
  EbreakCall ebreakDPI (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:54:25]
    .isEbreak (_instDec_io_isEbreak)	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  );
  Adder adder (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:55:25]
    .io_operand1 (_regFile_io_rs1Data),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:25]
    .io_operand2 (_instDec_io_isImmidiate ? _immGen_io_immidiate : _regFile_io_rs2Data),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25, :52:25, :53:25, :69:27]
    .io_result   (_adder_io_result)
  );
  assign io_instAddrOut = _pc_io_instAddr;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:50:25]
  assign io_debug_pcInstAddr = _pc_io_instAddr;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:50:25]
  assign io_debug_instDecRs1 = _instDec_io_rs1;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  assign io_debug_instDecRs2 = _instDec_io_rs2;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  assign io_debug_instDecRd = _instDec_io_rd;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  assign io_debug_instDecWriteEnable = _instDec_io_writeEnable;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  assign io_debug_instDecIsImmidiate = _instDec_io_isImmidiate;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:51:25]
  assign io_debug_regFileRs1Data = _regFile_io_rs1Data;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:52:25]
  assign io_debug_regFileRs2Data = _regFile_io_rs2Data;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:52:25]
  assign io_debug_immGenImmidiate = _immGen_io_immidiate;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:53:25]
  assign io_debug_adderResult = _adder_io_result;	// @[<stdin>:132:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:55:25]
endmodule
