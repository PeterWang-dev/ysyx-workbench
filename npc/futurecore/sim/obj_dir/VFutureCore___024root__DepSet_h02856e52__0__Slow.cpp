...
VL_ATTR_COLD void VFutureCore___024root___ctor_var_reset(VFutureCore___024root* vlSelf) {
    ...
    vlSelf->io_debug_pcInstAddrOutput = VL_RAND_RESET_I(32);
    vlSelf->FutureCore__DOT____Vtogcov__clock = VL_RAND_RESET_I(1);
    vlSelf->FutureCore__DOT____Vtogcov__reset = VL_RAND_RESET_I(1);
    vlSelf->FutureCore__DOT____Vtogcov__io_debug_pcInstAddrOutput = VL_RAND_RESET_I(32);
    vlSelf->FutureCore__DOT__pc__DOT__pc = VL_RAND_RESET_I(32);
    vlSelf->FutureCore__DOT__pc__DOT____Vtogcov__pc = VL_RAND_RESET_I(32);
