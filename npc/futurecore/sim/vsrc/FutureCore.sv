...
module InstDecoder(	// @[<stdin>:15:10]
  input  [31:0] io_inst,	// @[FutureCore/src/main/scala/futurecore/frontend/InstDecoder.scala:34:14]
  output [4:0]  io_rs1,	// @[FutureCore/src/main/scala/futurecore/frontend/InstDecoder.scala:34:14]
                io_rs2,	// @[FutureCore/src/main/scala/futurecore/frontend/InstDecoder.scala:34:14]
                io_rd	// @[FutureCore/src/main/scala/futurecore/frontend/InstDecoder.scala:34:14]
);

  assign io_rs1 = io_inst[19:15];	// @[<stdin>:15:10, FutureCore/src/main/scala/futurecore/frontend/InstDecoder.scala:36:28]
  assign io_rs2 = io_inst[24:20];	// @[<stdin>:15:10, FutureCore/src/main/scala/futurecore/frontend/InstDecoder.scala:37:28]
  assign io_rd = io_inst[11:7];	// @[<stdin>:15:10, FutureCore/src/main/scala/futurecore/frontend/InstDecoder.scala:38:28]
endmodule

module RegFile(	// @[<stdin>:29:10]
  ...
  assign io_rs1Data = (|io_rs1Addr) ? _regBank_ext_R0_data : 32'h0;	// @[<stdin>:29:10, FutureCore/src/main/scala/futurecore/backend/RegFile.scala:38:20, :40:{20,32}, :44:33]
  assign io_rs2Data = (|io_rs2Addr) ? _regBank_ext_R1_data : 32'h0;	// @[<stdin>:29:10, FutureCore/src/main/scala/futurecore/backend/RegFile.scala:38:20, :41:{20,32}, :44:33]
endmodule

module ImmGenerator(	// @[<stdin>:50:10]
...
module Adder(	// @[<stdin>:106:10]
  ...
  assign io_result = io_operand1 + io_operand2;	// @[<stdin>:106:10, FutureCore/src/main/scala/futurecore/backend/Adder.scala:33:28]
endmodule

module FutureCore(	// @[<stdin>:115:10]
  input         clock,	// @[<stdin>:116:11]
                reset,	// @[<stdin>:117:11]
  input  [31:0] io_instIn,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
  output [31:0] io_instAddrOut,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
                io_debug_pcInstAddr,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
  output [4:0]  io_debug_instDecRs1,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
                io_debug_instDecRs2,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
                io_debug_instDecRd,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
  output        io_debug_instDecWriteEnable,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
                io_debug_instDecIsImmidiate,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
  output [31:0] io_debug_regFileRs1Data,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
                io_debug_regFileRs2Data,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
                io_debug_immGenImmidiate,	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
                io_debug_adderResult	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:50:19]
);

  wire [31:0] _adder_io_result;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:55:23]
  wire [31:0] _immGen_io_immidiate;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:54:23]
  wire [31:0] _regFile_io_rs1Data;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:53:23]
  wire [4:0]  _instDec_io_rs1;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
  wire [4:0]  _instDec_io_rs2;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
  wire [4:0]  _instDec_io_rd;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
  wire [31:0] _pc_io_instAddr;	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:23]
  ProgramCounter pc (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:51:23]
    .clock       (clock),
    .reset       (reset),
    .io_instAddr (_pc_io_instAddr)
  );
  InstDecoder instDec (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
    .io_inst (io_instIn),
    .io_rs1  (_instDec_io_rs1),
    .io_rs2  (_instDec_io_rs2),
    .io_rd   (_instDec_io_rd)
  );
  RegFile regFile (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:53:23]
    .clock      (clock),
    .io_rs1Addr (_instDec_io_rs1),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
    .io_rs2Addr (_instDec_io_rs2),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
    .io_rdAddr  (_instDec_io_rd),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
    .io_rdData  (_adder_io_result),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:55:23]
    .io_rs1Data (_regFile_io_rs1Data),
    .io_rs2Data (io_debug_regFileRs2Data)
  );
  ImmGenerator immGen (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:54:23]
    .io_inst      (io_instIn),
    .io_immidiate (_immGen_io_immidiate)
  );
  Adder adder (	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:55:23]
    .io_operand1 (_regFile_io_rs1Data),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:53:23]
    .io_operand2 (_immGen_io_immidiate),	// @[FutureCore/src/main/scala/futurecore/FutureCore.scala:54:23]
    .io_result   (_adder_io_result)
  );
  assign io_instAddrOut = _pc_io_instAddr;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:51:23]
  assign io_debug_pcInstAddr = _pc_io_instAddr;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:51:23]
  assign io_debug_instDecRs1 = _instDec_io_rs1;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
  assign io_debug_instDecRs2 = _instDec_io_rs2;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
  assign io_debug_instDecRd = _instDec_io_rd;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23]
  assign io_debug_instDecWriteEnable = 1'h1;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23, :53:23]
  assign io_debug_instDecIsImmidiate = 1'h1;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:52:23, :53:23]
  assign io_debug_regFileRs1Data = _regFile_io_rs1Data;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:53:23]
  assign io_debug_immGenImmidiate = _immGen_io_immidiate;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:54:23]
  assign io_debug_adderResult = _adder_io_result;	// @[<stdin>:115:10, FutureCore/src/main/scala/futurecore/FutureCore.scala:55:23]
endmodule
